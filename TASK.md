...
- [ ] **R-008** Test coverage: run all tests, identify untested migration paths, add missing tests
- [ ] **R-009** Performance benchmark: API call latency kotlin_krx vs previous pykrx baseline
